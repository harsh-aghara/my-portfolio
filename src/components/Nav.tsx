...
const Nav: React.FC<Props> = ({ activeSection }) => {
  ...
  return (
    <nav className="fixed top-6 left-1/2 -translate-x-1/2 w-[95%] max-w-5xl h-14 bg-white/[0.03] backdrop-blur-xl border border-white/10 z-[500] px-8 rounded-full flex items-center justify-between shadow-2xl">
